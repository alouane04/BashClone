...
<p align="center">
  <a href="https://github.com/alouane04">
    <picture>
    <img alt="minishell" src="https://user-images.githubusercontent.com/68693691/193606493-2969e425-6bad-44ce-97af-89fec62bee22.gif" width=500>
    </picture>
  </a>
</p>

*A mini recreation(clone) of bash.  Implementing previously learned concepts like file descriptors and processes.  Made with [rida el mazary](https://github.com/Rida-el).*
...
#### Multiple Commands
If there are multiple commands, the executor loops through each `t_simple_cmds` node and creates a child process for it using `fork()`, and  using `pipe()` creates a pipe in order to send the output of one command as the input to the next.
...
``` 
git clone https://github.com/alouane04/BashClone.git
cd minishell
make
```
### Run Minishell
